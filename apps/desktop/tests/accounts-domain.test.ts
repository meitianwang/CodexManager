...
describe("accounts coordinator", () => {
  ...
  it("records the injected desktop platform source device id when switching accounts", async () => {
    ...
    expect(storeRepository.store.currentSelection?.sourceDeviceID).toBe("macos-local");
