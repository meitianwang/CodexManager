...
const sharedLabelParityKeys: Array<[MessageKey, string]> = [
  ...
  ["common.refresh_usage", "common.refresh_usage"],
  ...
  ["accounts.action.exporting", "accounts.action.exporting"],
  ["accounts.action.importing", "accounts.action.importing"],
  ["accounts.action.waiting_for_login", "accounts.action.waiting_for_login"],
  ...
  ["accounts.notice.weekly_no_targets", "accounts.notice.weekly_quota_warmup_no_targets"],
  ["accounts.notice.weekly_complete", "accounts.notice.weekly_quota_warmup_completed_format"],
  ["accounts.notice.weekly_partial", "accounts.notice.weekly_quota_warmup_partial_format"],
